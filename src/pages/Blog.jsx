...
const Blog = () => {
  return (
    <>
      <Meta
        title="Blog"
        description="Insights into beauty trends, behind-the-scenes looks at fashion weeks, and professional makeup tips from Copenhagen-based artist Tekla Kristjánsdóttir."
      />
