...
const Contact = () => {
  ...
  return (
    <>
      <Meta
        title="Contact"
        description="Book Tekla Kristjánsdóttir for your bridal makeup, editorial shoot, or special event. Based in Copenhagen and available for worldwide bookings."
      />
