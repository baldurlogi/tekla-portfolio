...
const Home = () => {
  ...
  return (
    <>
      <Meta
        title="TEKLA - Makeup Artist & Designer"
        description="TEKLA KRISTJÁNSDÓTTIR - Makeup Artist and Hair Stylist. Specializing in bridal beauty, editorial, and fashion."
      />
      <div className="flex flex-col gap-24">
        ...
        <section className="bg-[#f8f0e4] py-20 text-center">
          ...
          <Link
            to="/contact"
            className="mt-6 inline-block px-10 py-3 bg-neutral-800 text-white uppercase tracking-wider hover:opacity-90 rounded-md"
          >
            Get in touch
          </Link>
        </section>
