...
const Gallery = () => {
  ...
  return (
    <>
      <Meta
        title="Gallery"
        description="Explore Tekla Kristjánsdóttir's professional makeup and hair styling portfolio, featuring editorial, fashion week, and commercial projects with leading brands and magazines."
      />
